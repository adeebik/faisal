...
export const portfolioData = {
  ...
  certifications: [
    ...
    {
      id: "cert-3",
      title: "LPU Academic & Professional Distinction",
      issuer: "Lovely Professional University",
      date: "Dec 2025",
      badge: "Academic Honor",
      image: "/certificates/lpu_distinction.jpg",
      description: "Official university recognition for academic excellence in MBA Marketing & Sales, maintaining an exemplary 8.56 CGPA and demonstrating outstanding leadership.",
      skillsLearned: ["Marketing Strategy", "Sales Force Management", "Market Research", "Strategic Leadership"],
    },
    {
      id: "cert-4",
